...
publications = pd.read_csv("publications.txt", sep="\t", header=0)  # excel doesnt save .tsv files!
publications
...
for row, item in publications.iterrows():
    ...
    item.citation = make_citation(item.citation, year, item.title, item.venue)
